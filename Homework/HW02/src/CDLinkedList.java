public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
	    ...
	    if(((DListIterator) f1).currentNode.nextNode == ((DListIterator) s2).currentNode) {
	    	DListIterator p1 = new DListIterator(((DListIterator) s1).currentNode.previousNode);
	    	DListIterator p2 = new DListIterator(((DListIterator) f2).currentNode.nextNode);
	    	//left
	    	p1.currentNode.nextNode=((DListIterator) s2).currentNode;
	    	((DListIterator) s2).currentNode.previousNode=p1.currentNode;
	    	//middle
	    	...
	    	//right
	    	((DListIterator) f1).currentNode.nextNode=p2.currentNode; 
	    	p2.currentNode.previousNode=((DListIterator) f1).currentNode;
	    }
	    else {
	    	DListIterator p1 = new DListIterator(((DListIterator) s1).currentNode.previousNode);
	    	DListIterator p2 = new DListIterator(((DListIterator) f1).currentNode.nextNode);
	    	DListIterator p3 = new DListIterator(((DListIterator) s2).currentNode.previousNode);
	    	DListIterator p4 = new DListIterator(((DListIterator) f2).currentNode.nextNode);
	    	//left
	    	p1.currentNode.nextNode=((DListIterator) s2).currentNode;
	    	((DListIterator) s2).currentNode.previousNode=p1.currentNode;
	    	//mid-left
	    	((DListIterator) f2).currentNode.nextNode=p2.currentNode;
	    	p2.currentNode.previousNode=((DListIterator) f2).currentNode;
	    	//mid-right
	    	p3.currentNode.nextNode=((DListIterator) s1).currentNode;
	    	((DListIterator) s1).currentNode.previousNode=p3.currentNode;
	    	//right
	    	((DListIterator) f1).currentNode.nextNode=p4.currentNode;
	    	p4.currentNode.previousNode=((DListIterator) f1).currentNode;
	    }
	}
